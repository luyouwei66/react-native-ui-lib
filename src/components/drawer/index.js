...
class Drawer extends PureComponent {
  ...
  _swipeableRow = /*#__PURE__*/React.createRef();
  animationOptions = {
  ...
  renderAction = ({
    ...
    return /*#__PURE__*/React.createElement(RectButton, {
      key: index,
      testID: item.testID,
    ...
    }, item.icon && /*#__PURE__*/React.createElement(Animated.Image, {
      source: item.icon,
    ...
    }), item.text && /*#__PURE__*/React.createElement(Animated.Text, {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Swipeable, _extends({}, others, {
    ...
    }, extractAccessibilityProps(this.props)), children));
  }
